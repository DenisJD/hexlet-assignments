...
class ValidationTest {
    ...
    void testAdvancedValidate() {
        Address address = new Address("USA", "Texas", null, "7", "3");
        Map<String, List<String>> result = new LinkedHashMap<>();
        result.put("country", List.of("length less than 4"));
        result.put("street", List.of("can not be null"));
        Map<String, List<String>> expected = Validator.advancedValidate(address);
